  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get('http://127.0.0.1:8000/api/auth/audit/save-draft/', {
          headers: {
                      ...
                      <Grid item xs={12} sm={6} key={errorCase.id}>
                        <Paper elevation={3} sx={{ p: 2, borderRadius: 2 }}>
                          <Typography variant="body2" sx={{ mb: 1 }}>
                            <strong>Category:</strong> {errorCase.select_category}
                          </Typography>
                          <Typography variant="body2" sx={{ mb: 1 }}>
                    ...
                    {item.componentsWithError.map((component) => (
                      <Grid item xs={12} sm={6} key={component.id}>
                        <Paper elevation={3} sx={{ p: 2, borderRadius: 2 }}>
                          ...
                          <Typography variant="body2" sx={{ mb: 1 }}>
                            <strong>Category:</strong> {component.select_category}
                          </Typography>
                          <Typography variant="body2" sx={{ mb: 1 }}>
