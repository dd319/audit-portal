...
from .views import AdminDeleteSubmittedAuditView, AdminEditSubmittedAuditView, AllAuditsView, DeleteDraftAuditView, GoogleLoginView, RefreshTokenView, SaveDraftAuditView, SubmitAuditView, DraftUpdateView, UserAuditsView
...
urlpatterns = [
    ...
    path('all-audits/edit-audit/<int:pk>/', AdminEditSubmittedAuditView.as_view(), name='admin-edit-audit'),
    path('all-audits/delete-audit/<int:pk>/', AdminDeleteSubmittedAuditView.as_view(), name='admin-delete-audit'),
]