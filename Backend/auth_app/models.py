...
class FileAttachment(models.Model):
    ...
    component_with_error = models.ForeignKey('ComponentWithError', related_name='file_attachments', on_delete=models.CASCADE, null=True, blank=True)
    error_case = models.ForeignKey('ErrorCase', related_name='file_attachments', on_delete=models.CASCADE, null=True, blank=True)
...
class ComponentWithError(models.Model):
    ...
    sub_barcode = models.CharField(max_length=16, blank=True, null=True)
